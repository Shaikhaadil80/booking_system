...
//       'location_subtitle': 'Discover Bangkok from P29',
...
//       'welcome_desc': 'ตั้งอยู่ในย่านหนองแขมที่เงียบสงบ P29 โฮสเทลมีห้องครอบครัวที่ทันสมัยพร้อมเครื่องปรับอากาศ ห้องน้ำส่วนตัว และวิวสวนหรือเมืองที่สวยงาม ห้องพักแต่ละห้องมีระเบียง เครื่องซักผ้า และ WiFi ฟรี พักผ่อนในสวน ระเบียง หรือบาร์ของเรา พร้อมด้วยมินิมาร์ทและร้านกาแฟ',
//       'rooms': 'ห้องพักของเรา',
...
//       'location_title': 'ทำเล',
//       'location_subtitle': 'ค้นพบกรุงเทพฯ จาก P29',
...
//       'welcome_desc': 'Расположенный в тихом районе Нонг Кхэм, хостел P29 предлагает современные семейные номера с кондиционером, отдельными ванными комнатами и потрясающим видом на сад или город. В каждом номере есть балкон, стиральная машина и бесплатный WiFi. Отдохните в нашем саду, на террасе или в баре, наслаждаясь нашим мини-маркетом и кофейней.',
//       'rooms': 'Наши номера',
...
//       'location_subtitle': 'Откройте для себя Бангкок из P29',
...
//       'welcome_desc': 'P29旅舍位于宁静的农凯区，提供现代化的家庭房，配有空调、私人浴室以及美丽的花园或城市景观。每间客房均设有阳台、洗衣机和免费WiFi。在我们的花园、露台或酒吧放松身心，同时享受我们的迷你市场和咖啡店。',
//       'rooms': '我们的客房',
